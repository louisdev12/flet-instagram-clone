...
def emailverification_view(page: ft.Page):
    ...
    def handle_confirm_number(e):
        ...
        page.open(
            ft.SnackBar(
                content=ft.Text("Verification code sent to +instgram@gmail.com", color=ft.Colors.WHITE),
    ...
    top_section = ft.Container(
        content=ft.Column(
            [
                ...
                ft.Text(
                    "To confirm your account, enter the 6 digit code that we sent via your email address to instagram@gmail.com",
                    size=15,
    ...
    confirm_button = ft.ElevatedButton(
        content=ft.Text(
            "Send code to instagram@gmail.com",
            color=ft.Colors.WHITE,
            size=16,
            weight=ft.FontWeight.BOLD,
        ),
        ...
        ft.Container(
            ft.Column(
                [
                    ...
                    ft.Container(height=15),
                    ft.Text(
                        "We'll send a verification code to confirm this is your email address. Standard message and data rates may apply.", 
                        size=16,
                        text_align=ft.TextAlign.CENTER,
                    ),
